  ...
  const getPortfolios = async () => {
    ...
    const response = await fetch(`${host}/api/portfolio/fetchallportfolios`, {
      ...
      headers: {
        ...
        "auth-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjE0OWU2YzJkMTA4NjRkMzQyYjNmZDdhIn0sImlhdCI6MTYzMjIzMzE1NH0.2DQXPh-4K3gKMpoSS0NbissBCKBMh6dlVKwLIYtm3mg"
      }
    });
